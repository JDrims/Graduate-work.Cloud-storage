package ru.jdrims.cloudservice;
...
import ru.jdrims.cloudservice.dto.FileNameInRequest;
...
class CloudServiceApplicationTests {
    ...
    public void testLogin() {
        userRepository.save(new UserEntity("user", "pass"));
        final HttpHeaders headers = new HttpHeaders();
        headers.set("Content-Type", "application/json");

        final LoginInRequest operation = new LoginInRequest("user", "pass");
